...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            ?>
            <h1>Voici votre catalogue - Total : <?php echo $resulte; ?> articles</h1><br/>
            <?php $Session->flash();  ?>
            <div class="btn-group btn-group-justified" role="group" aria-label="...">
                <div class="btn-group" role="group">
                    <a href="form_new_art.php"><button type="button" class="btn btn-primary">Ajouter un article</button></a>
                </div>
            </div>

            <?php
            $req=$bdd->query("SELECT * FROM articles INNER JOIN fournisseur ON fournisseur.fournisseur_id = articles._fournisseur_id ORDER BY article_description");
            $result=$req->fetchAll();?><br/>
            ...
            <table class="table table-striped">
                ...
                <?php foreach($result as $cle=>$valeur): ?>
                    <tr>
                        ...
                        <td><a href="form_modif_art.php?id=<?php echo $valeur['article_id']; ?>">Modifier <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></td>
                        <td><a href="valide_sup_art.php?id=<?php echo $valeur['article_id']; ?>">Supprimer <i class="fa fa-trash" aria-hidden="true"></i></a></td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
