...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  `article_designation` varchar(30) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `article_description` varchar(200) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `article_prix_vente` double NOT NULL,
  `article_quantite` int(11) NOT NULL,
  `_fournisseur_id` int(11) NOT NULL
...
INSERT INTO `articles` (`article_id`, `article_designation`, `article_description`, `article_prix_vente`, `article_quantite`, `_fournisseur_id`) VALUES
(2, 'RV118', 'REVEIL MULTIFONCTION a EAU', 28.78, 50, 1),
(3, 'LP34', 'LAMPE TORCHE SOLAIRE', 20.49, 83, 2),
...
(17, 'CL109OR', 'CALCULATRICE DYNAMO 8 CHIFFRES', 4.91, 39, 1),
...
(144, 'RV115', 'HORLOGE DE BUREAU', 8.3, 26, 8),
...
--
ALTER TABLE `articles`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=542;
